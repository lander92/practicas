	...
	<body>
		...
		<div class="row" id="main">
			<div class="col-xs-12 col-md-7" id="descripcion">
				<p>
					Tekno 2000 es una empresa con amplia experiencia en el mundo informático.
					Creada en 1986, su evolución y crecimiento ha sido constante a lo largo de estos años.
				</p>
				<p>
